...
#;originally I wanted to create this in ASM 
#;purely but decided to opt for utilizing c++ 
#;thinking back ASM might have been a better choice for this project

#;so as of now i will dedicate to understanding how to make chip8 
#;function in ASM
...
ep_parseop:
	...
	movsxd rcx, dword ptr [rdx+rcx*4]  #; Offset value
...
ep_op8:
	...
	movsxd r10, dword ptr [rax+r10*4]  #; Offset value
